...
public class CustomCropImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CustomCropImageView(Context context, AttributeSet attrs, int defStyle) {
